package com.example.lesson7.sqlitedemo.data;
...
public class DBManager extends SQLiteOpenHelper {
    ...
    public DBManager(Context context) {
        super(context, DATABASE_NAME, null, VERSION); // getFileDirs() // data/data/packagename/databases/ tendb
    ...
    public void addStudent(Student student) {
        ...
        //db.rawQuery("Insert into "+ TABLE_NAME, null);
